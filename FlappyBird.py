...
def score_display(game_state):
    if game_state == 'main_game':
        ...
        autor_surface = game_font.render('reMade by Maciej Switala', True, (255,255,255))
        autor_rect = autor_surface.get_rect(center = (288,850))
...
# bird_rect = bird_surface.get_rect(center = (170, 512))
